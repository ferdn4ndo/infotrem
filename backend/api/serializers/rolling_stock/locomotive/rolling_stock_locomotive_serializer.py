...
from api.serializers.rolling_stock.locomotive.rolling_stock_locomotive_model_serializer import \
    RollingStockLocomotiveModelSerializer
from core.models import Locomotive, LocomotiveDesign, RollingStock
