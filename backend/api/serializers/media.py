...
from api.models.media import ImageMediaItem, MediaItem, MediaItemRollingStock
...
from api.serializers.rolling_stock import RollingStockSerializer
from api.serializers.storage import StorageFileSerializer
from api.serializers.user import UserSerializer
from api.validators.file import FileValidator
...
class MediaItemRollingStockFromNameSerializer(serializers.Serializer):
    ...
    def to_representation(self, instance: MediaItemRollingStock):
        """Convert the MediaRollingStock to the serializer fields"""
