...
def run():
    ...
    metric_gauge = TrackGaugeConfiguration.objects.get(tag='NARROW')
    ...
    large_gauge = TrackGaugeConfiguration.objects.get(tag='BROAD')
    ...
    logging.info("Freight car types created")
