...
class InformationEffectService:
    ...
    @staticmethod
    def create_effects_from_data(effects_data: List, information: Information, created_by: str) -> List[InformationEffect]:
        effects = []
    ...
    @staticmethod
    def update_effects_from_data(effects_data: List, information: Information, updated_by: str) -> List[InformationEffect]:
