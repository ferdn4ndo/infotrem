...
<title>Listar Vag&otilde;es</title>
...
<form id="form1" name="form1" method="post" action="#"><div align="center">
  ...
  <tr>
    <td colspan="11" class="headertabela"><div align="center">Listar Vag&otilde;es</div></td>
      </tr>
    <tr>
 ...
 ?> 
  <tr>
      ...
      <td><div align="center"><? echo $row['TipoVag'] . $row['LetraPesoVag'];?></div></td>
