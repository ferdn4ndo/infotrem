...
<title>Inserir Tipo de Carro</title>
...
if(isset($_POST['txtLetra'])) {
	...
	if($erro == 0){
		...
		$sqlverifica = "SELECT * FROM tblTipoCarro WHERE LetraTipoCarro = '" . $letra . "';";
		
		if(mysql_num_rows(mysql_query($sqlverifica)) > 0) { //Se já houver um registro igual
			echo $Mensagem['erroduplicado'];
		} else {
			$sql = "INSERT INTO tblTipoCarro (LetraTipoCarro, TipoCarro) VALUES('" . $letra . "','" . $txtTipo . "');";
...
<form id="form1" name="form1" method="post" action="#"><div align="center">
  ...
  <tr>
    <td colspan="2" class="headertabela"><div align="center">Cadastrar Tipo de Carro</div></td>
      </tr>
    <tr>
