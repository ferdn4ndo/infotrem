...
<title>Cadastrar Tipo de Tra&ccedil;&atilde;o</title>
...
<form id="form1" name="form1" method="post" action="#"><div align="center">
  <table width="500" border="1" cellspacing="0" cellpadding="0">
    <tr>
      <td colspan="2" class="headertabela"><div align="center">Cadastrar Tipo de Tra&ccedil;&atilde;o</div></td>
    </tr>
    <tr>
      <td width="119"  class="headertabela"><div align="right">Tipo de Tra&ccedil;&atilde;o:</div></td>
      <td width="196" bgcolor="#FFFFFF"><span class="style2">
        <input name="txtTracao" type="text" id="txtTracao" size="30" maxlength="50" />
      </span></td>
    </tr>
    <tr>
