...
<title>Inserir Peso de Vag&atilde;o</title>
...
<form id="form1" name="form1" method="post" action="#"><div align="center">
  ...
  <tr>
    <td colspan="2" class="headertabela"><div align="center">Cadastrar Peso de Vag&atilde;o</div></td>
      </tr>
    <tr>
    ...
    <tr>
      <td width="119"  class="headertabela"><div align="right">Peso:</div></td>
      <td width="196" bgcolor="#FFFFFF"><span class="style2">
        <input name="txtPeso" type="text" id="txtPeso" size="10" maxlength="3" />
      </span></td>
    </tr>
    <tr>
