...
<title>Inserir Estado de Local</title>
...
if(isset($_POST['txtEstado'])) {
	...
	if($erro == 0){
		...
		$sqlverifica = "SELECT * FROM tblEstadoLocal WHERE Estado = '" . $txtEstado . "';";
		
		if(mysqlcontar($id,$sqlverifica) > 0) { //Se já houver um registro igual
			echo $Mensagem['erroduplicado'];
		} else {
			$sql = "INSERT INTO tblEstadoLocal (Estado) VALUES('" . $txtEstado . "');";
...
<form id="form1" name="form1" method="post" action="#"><div align="center">
  <table width="500" border="1" cellspacing="0" cellpadding="0">
    <tr>
      <td colspan="2" class="headertabela"><div align="center">Cadastrar Estado de Local</div></td>
    </tr>
    <tr>
