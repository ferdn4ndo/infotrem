...
<title>Inserir Categoria de V&iacute;deo</title>
...
if(isset($_POST['txtCategoria'])) {
	...
	if($erro == 0){
		...
		$sqlverifica = "SELECT * FROM tblCategoriaVideo WHERE Categoria = '" . $txtCategoria . "';";
		if(mysqlcontar($id,$sqlverifica) > 0) { //Se já houver um registro igual
			...
			//Faz o cadastro
			$sql = "INSERT INTO tblCategoriaVideo (Categoria) VALUES('" . $txtCategoria . "');";
...
<form id="form1" name="form1" method="post" action="#"><div align="center">
  ...
  <tr>
    <td colspan="2" class="headertabela"><div align="center">Cadastrar Categoria de V&iacute;deo</div></td>
      </tr>
    <tr>
    
      <td width="119"  class="headertabela"><div align="right">Categoria:</div></td>
      <td width="196" bgcolor="#FFFFFF"><span class="style2">
        <input name="txtCategoria" type="text" id="txtCategoria" size="30" maxlength="255" />
      </span></td>
    </tr>
    <tr>
